// % who marry and have kid in same year over time
...
gen marandkid = 0
replace marandkid = 1 if MARRINYR == 2 & FERTYR == 2

tab YEAR marandkid if womanage1544 == 1 , row
tab YEAR marandkid if womanage1544 == 1 & FERTYR == 2, row
...
putexcel set "$nmfratioresults/T1componentsNMFR_altmarriage.xlsx", replace

putexcel A1 = "Table 1. Components of nonmarital fertility ratio for women ages 15-44 in the United States using alternative definition of marriage, 2000-2023"
...
putexcel A28 = "Note: Population and proportion married estimates for each year come from the American Community Survey. Alt marriage definition uses ACS data on whether someone got married in the last year and if the answer is yes, they get considered not married for rate construction."
...
list propfemmarALT1544
mkmat propfemmarALT1544, matrix(propmarried)
...
gen nonmaritalbirths = Rate * popfem1544unmarALT if Maritalstatus == "0"
gen maritalbirths = Rate * popfem1544marALT if Maritalstatus == "1"
